...
class Road {
	...
	public static final int BIG_VALUE = 1000007;
	public static final int Big_value = 100007;
	public static final Color DANGER_COLOR = Color.yellow;
	public static final Color SAFE_COLOR = Color.green;
	public static final Color NULL_COLOR = Color.darkGray;
	public static final Color DANGER_ROTATE_COLOR = Color.black;
	public static final Color SEARCHING_COLOR = Color.blue;
	//道路id，道路长度，道路速度限制，道路的条数，道路的出发路口，道路的结束路口， 道路是否为双向，当前道路上的车数
	int id, length, speedLimit, laneNum, begin, end, isDouble,carNum;
	
	private Color ColorBeginEnd, ColorEndBegin;
	void setPositiveColor(Color color) {
		ColorBeginEnd = color;
	}
	void setNegetiveColor(Color color) {
		ColorEndBegin = color;
	}
	Color getPositiveColor() {
		return ColorBeginEnd;
	}
	Color getNegetiveColor() {
		return ColorEndBegin;
	}
	//开始的路口
